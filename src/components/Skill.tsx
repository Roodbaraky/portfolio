...
export default function Skill({ title, description, children }: SkillProps) {
  return (
    <div
      ...
      className="outline outline-1 outline-base-content  hover:-translate-y-1 shadow hover:shadow-lg transition-all duration-200 ease-in-out rounded-2xl p-4 flex flex-col justify-between min-h-96 min-w-80 max-w-80 sm:max-w-96" 
    >
      <div>
