...
export default function Skill({ title, description, children }: SkillProps) {
  return (
    <div
      ...
      className="outline outline-secondary-content hover:outline-secondary hover:outline-4 hover:scale-105  shadow hover:shadow-lg transition-all duration-500 ease-in-out rounded-2xl p-4 flex flex-col justify-between min-h-96 min-w-96 max-w-96"
    >
      <div>
